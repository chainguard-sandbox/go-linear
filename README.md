...
| **MCP** | Exposes CLI as 89 tools for AI agents |
...
See [CLI Quick Start](docs/CLI-QUICK-START.md) for all 89 commands and [Filters Guide](docs/FILTERS.md) for 44 filter options.
...
**Status**: v1.x stable. Semantic versioning.
