...
| **MCP** | Exposes CLI as 74 tools for AI agents |
...
See [CLI Quick Start](docs/CLI-QUICK-START.md) for all 74 commands and [Filters Guide](docs/FILTERS.md) for 44 filter options.
