...
const (
	mockRoadmapsResponse = `{"data": {"roadmaps": {"nodes": [{"id": "road-123", "name": "Q1 Roadmap", "description": "Q1 planning", "createdAt": "2024-01-01T00:00:00.000Z"}], "pageInfo": {"hasNextPage": false}}}}`
	mockRoadmapResponse  = `{"data": {"roadmap": {"id": "road-123", "name": "Q1 Roadmap", "description": "Q1 planning", "createdAt": "2024-01-01T00:00:00.000Z"}}}`
)
